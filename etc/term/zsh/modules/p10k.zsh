...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=42
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND=52
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=53
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=53
  ...
  function my_git_formatter() {
    ...
    local      clean='%50F' # black foreground
    local   modified='%50F' # black foreground
    local  untracked='%50F' # black foreground
  ...
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=88
