# =============================================================================
# Yvan Vivid - dotfiles - p10k prompt config
# =============================================================================
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    os_icon time context virtualenv aws docker_machine background_jobs
    command_execution_time status
    newline root_indicator dir_writable dir vcs
    newline history prompt_char
  )
  ...
  if [[ $TERM == linux ]]
  then POWERLEVEL9K_MODE='compatible'
  else POWERLEVEL9K_MODE='nerdfont-complete'
  fi
  ...
  typeset -g POWERLEVEL9K_DIR_HOME_BACKGROUND='red'
  typeset -g POWERLEVEL9K_DIR_HOME_SUBFOLDER_FOREGROUND='black'
  typeset -g POWERLEVEL9K_DIR_HOME_SUBFOLDER_BACKGROUND='red'
  typeset -g POWERLEVEL9K_DIR_DEFAULT_FOREGROUND='black'
  typeset -g POWERLEVEL9K_DIR_DEFAULT_BACKGROUND='red'
  typeset -g POWERLEVEL9K_SHORTEN_DIR_LENGTH=3
  typeset -g POWERLEVEL9K_SHOW_WRITABLE=true
  ...
  typeset -g POWERLEVEL9K_STATUS_BACKGROUND='blue'
